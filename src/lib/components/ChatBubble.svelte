...
{#if isOpen}
  ...
  >
    ...
    >
      <!-- Header -->
      <div
        class="flex items-center justify-between p-4 border-b border-gray-300 dark:border-text-muted/20"
      >
        ...
        <button
          onclick={closeChat}
          class="text-gray-500 dark:text-text-muted hover:text-gray-900 dark:hover:text-text-primary transition-colors"
        >
          <svg
            class="w-5 h-5"
            fill="none"
          ...
          >
            <div
              class="max-w-[80%] {msg.sender === 'user'
                ? 'bg-accent'
                : 'bg-gray-200 dark:bg-dark-200'} rounded-2xl px-4 py-2"
            >
              <p
              ...
              <span
                class="text-xs {msg.sender === 'user'
                  ? 'text-white/80'
                  : 'text-gray-600 dark:text-gray-300'} mt-1 block"
              >
          ...
          <div class="flex justify-start">
            <div class="bg-gray-200 dark:bg-dark-200 rounded-2xl px-4 py-3">
              <div class="flex gap-1">
                <div
                  class="w-2 h-2 bg-gray-500 dark:bg-text-muted rounded-full animate-bounce"
      ...
      <div class="px-4 py-2 border-t border-gray-300 dark:border-text-muted/20">
        <div class="flex gap-2 overflow-x-auto pb-2">
          ...
          <button
            onclick={() => {
              message = "¿Cómo puedo contactarte?";
              sendMessage();
            }}
            class="text-xs px-3 py-1.5 bg-gray-200 hover:bg-gray-300 dark:bg-dark-200 dark:hover:bg-dark text-gray-700 dark:text-text-secondary rounded-full whitespace-nowrap transition-colors"
          >
